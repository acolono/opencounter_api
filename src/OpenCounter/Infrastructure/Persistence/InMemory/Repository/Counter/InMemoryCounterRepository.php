...
use OpenCounter\Domain\Repository\OpenCounter;
...
class InMemoryCounterRepository implements CounterRepositoryInterface {
  ...
  public function __construct()
  {
    $this->counters[] = new Counter(
      new CounterId('8CE05088-ED1F-43E9-A415-3B3792655A9B'), new CounterName('twocounter'), new CounterValue(2), 'active', 'passwordplaceholder'
    );
    $this->counters[] = new Counter(
      new CounterId('62A0CEB4-0403-4AA6-A6CD-1EE808AD4D23'), new CounterName('test'), new CounterValue(0), 'locked', 'passwordplaceholder'
    );
    $this->counters[] = new Counter(
      new CounterId('62A0CEB4-4575-4AA6-FD76-1EE808AD4D23'), new CounterName('onecounter'), new CounterValue(1), 'disabled', 'passwordplaceholder'
    );
  }
